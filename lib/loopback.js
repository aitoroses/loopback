...
loopback.UserIdentity = require('./models/user-identity').UserIdentity;
loopback.UserCredential = require('./models/user-identity').UserCredential;
loopback.ApplicationIdentity = require('./models/application-credential');
...
loopback.UserIdentity.autoAttach = dataSourceTypes.DB;
loopback.UserCredential.autoAttach = dataSourceTypes.DB;
...
loopback.ApplicationIdentity.autoAttach = dataSourceTypes.DB;
